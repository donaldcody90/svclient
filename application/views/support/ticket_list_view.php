			...
			<div class="ticketlist">
				...
				<div>
					...
					<div class= "search">
						<?php echo form_open(base_url().'support/lists', 'method= "GET"'); ?>
							<input type="search" value="<?php echo $this->input->get('filter_c_title'); ?>" placeholder="Search by Title" name="filter_c_title" />
						<?php echo form_close(); ?>
					</div>
				</div>
				...
				<table class="main-content">
					...
					<?php foreach($result as $row){ ?>
						<tr>
							<td><a href="<?php echo base_url().'support/ticket/'.$row->c_id; ?>"><?php echo $row->c_title.'<br>'.$row->c_id; ?></a></td>
